...
import traceback
import sys
import python.article


class MainHandler(tornado.web.RequestHandler):# ���нӿ�
...
class ModuleListHandler(tornado.web.RequestHandler):# ����ģ��
    __metaclass__ = meta.HandlerMetaClass
    route = r'/modules'
    def get(self):
        self.set_header('Content-Type', 'text/xml; charset=utf-8')
...
class CrossDomainHandler(tornado.web.RequestHandler):# ��������ʽ
    __metaclass__ = meta.HandlerMetaClass
    route = r'/cross'
...
class MainHandler(meta.RequestHandlerBase):# ��������ʱ��·��Ĭ����ת
    __route__ = r'/'
    def get(self):
